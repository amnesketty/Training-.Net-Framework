...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-h1kpa18071679_api1.business.example.com";
    private string APIPassword = "BNWXHXQWKTTLV7CB";
    private string APISignature = "An9GxgTr.NE0jlP2YXRrCK5ecGXEAhygLq8qcq7NGDNib-MSzxezdSZq";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (ToyKingdom.Logic.ShoppingCartActions myCartOrders = new ToyKingdom.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            ToyKingdom.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
